...
import { feather, heroicons, iconsmind, material, customicons } from 'app/mock-api/ui/icons/data';
...
export class IconsMockApi
{
    ...
    private readonly _customicons: any = customicons;
        ...
        this._fuseMockApiService
            ...
            .reply(() => [
                200,
                {
                    ...
                    name     : 'Custom Icons',
                    grid     : 'icon-size-5',
                    list     : cloneDeep(this._customicons)
                }
            ]);
